...
def gerar_bloco_ignicao(df: pd.DataFrame, filename='bloco_ignicao.html'):
    ...
    .bloco-ignicao .tabela-ignicao-container:hover { transform: translateY(-2px); box-shadow: 0 15px 35px rgba(0,0,0,0.15); transition: box-shadow 0.3s, transform 0.3s;}
...
if __name__ == "__main__":
    # This part of the code is now redundant as the function expects a DataFrame directly.
    # If you want to test, you would need to load a DataFrame first.
    # For example:
    # df = pd.read_csv('Tempo_ignicao/tempo_ignicao_viagens.csv', encoding='utf-8-sig')
    # gerar_bloco_ignicao(df)
    pass
