...
def gerar_csv_blocos(blocos, df_original, nome_arquivo="efeito estrela/distancia_blocos.csv", gerar_incremento=False, nome_arquivo_incremento="efeito estrela/distancia_blocos_incremento.csv"):
